...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{2nd_tour_progr/01_Tribot/01_move_once_started/solution/01_move_once_01.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{2nd_tour_progr/01_Tribot/01_move_once_started/solution/01_move_once_02.pdf}
	\caption{График движения всенаправленной тележки (пример 1)}
	\label{fig:01_move_once_02}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{2nd_tour_progr/01_Tribot/01_move_once_started/solution/01_move_once_03.pdf}
