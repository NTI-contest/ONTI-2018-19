\section{Легенда}
\input{final/command_tour/irs/team_intro.tex}
...
\input{final/command_tour/irs/assignements.tex}

\section{Описание модели логистического центра}
\input{final/command_tour/irs/description.tex}

\section{Описание конструктора}
\input{final/command_tour/irs/hardware.tex}

\section{Условия проведения}
\input{final/command_tour/irs/conditions.tex}

\section{Процедура проведения приемочных запусков и
критерии оценки}
\input{final/command_tour/irs/scoring.tex}
...
\input{final/command_tour/irs/winners.tex}
