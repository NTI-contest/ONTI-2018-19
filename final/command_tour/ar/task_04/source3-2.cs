...
public class GyroCamera : MonoBehaviour
{
   ...
   private void Update()
   {
       ...
       transform.rotation = Quaternion.Slerp(transform.rotation, _rawGyroRotation.rotation, 
                                            _smoothing);
   }
   ...
   private IEnumerator CalibrateYAngle()
   {
       ...
       _smoothing = 1;
       _calibrationYAngle =
           _appliedGyroYAngle - _initialYAngle; // Offsets the y angle 
                                                // in case it wasn't 0 at edit time.
       yield return null;
   ...
   private void ApplyGyroRotation()
   {
       ...
       _rawGyroRotation.Rotate(0f, 0f, 180f, Space.Self); // Swap "handedness" 
                                                          // of quaternion from gyro.
   ...
   private void ApplyCalibration()
   {
       _rawGyroRotation.Rotate(0f, -_calibrationYAngle, 0f,
           Space.World); // Rotates y angle back 
                         // however much it deviated when calibrationYAngle was saved.
   }
